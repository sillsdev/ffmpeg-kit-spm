...
FFMPEG_KIT_TAG="v5.1.13"
FFMPEG_KIT_CHECKOUT="origin/develop"
#FFMPEG_KIT_CHECKOUT="origin/tags/$FFMPEG_KIT_TAG"
FFMPEG_KIT_IOS_MIN_DEPLOYMENT="15.6"
FFMPEG_KIT_REPO="https://github.com/sillsdev/ffmpeg-kit"
...
./ios.sh --target=$FFMPEG_KIT_IOS_MIN_DEPLOYMENT --enable-ios-audiotoolbox --enable-ios-avfoundation --enable-ios-videotoolbox --enable-ios-zlib --enable-ios-bzip2 --no-bitcode --enable-lame  -x
